 ...
 * @author Piotrek
 */
public class SurnameValidator extends InputVerifier {

    JLabel errorLabel;
    Pattern pattern = Pattern.compile("[A-ZĆŁŃÓŚŹŻ][ąćęłńóśźża-z]+([-][A-ZĆŁŃÓŚŹŻ][ąćęłńóśźża-z]+)?");

    public SurnameValidator(JLabel errorLabel) {
