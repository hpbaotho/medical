...
public class GUIDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        visitDoctorjPopupMenu = new javax.swing.JPopupMenu();
        ...
        treatmentPatientjTreeScrollPane = new javax.swing.JScrollPane();
        treatmentPatientJTree = new javax.swing.JTree();
        ...
        visitDoctorjPopupMenu.add(addVisitjMenuItem);
        ...
        javax.swing.GroupLayout visitPatientPanelLayout = new javax.swing.GroupLayout(visitPatientPanel);
        visitPatientPanel.setLayout(visitPatientPanelLayout);
        visitPatientPanelLayout.setHorizontalGroup(
            visitPatientPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(visitPatientPanelLayout.createSequentialGroup()
                .addContainerGap()
        ...
        visitPatientPanelLayout.setVerticalGroup(
            visitPatientPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(visitPatientPanelLayout.createSequentialGroup()
                .addGroup(visitPatientPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        treatmentPatientJTree.addTreeSelectionListener(new javax.swing.event.TreeSelectionListener() {
            public void valueChanged(javax.swing.event.TreeSelectionEvent evt) {
                treatmentPatientJTreeValueChanged(evt);
            }
        });
        treatmentPatientjTreeScrollPane.setViewportView(treatmentPatientJTree);
        ...
        javax.swing.GroupLayout treatmentPatientPanelLayout = new javax.swing.GroupLayout(treatmentPatientPanel);
        treatmentPatientPanel.setLayout(treatmentPatientPanelLayout);
        treatmentPatientPanelLayout.setHorizontalGroup(
            treatmentPatientPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(treatmentPatientPanelLayout.createSequentialGroup()
                .addContainerGap()
            ...
            .addComponent(treatmentPatientjTreeScrollPane, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 408, Short.MAX_VALUE)
        );
        treatmentPatientPanelLayout.setVerticalGroup(
            treatmentPatientPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(treatmentPatientPanelLayout.createSequentialGroup()
                .addGroup(treatmentPatientPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(treatmentPatientjTreeScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        visitPatientItem.setText("Przeglądaj wizyty jako pacjent");
        visitPatientItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        treatmentPatientItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.InputEvent.ALT_MASK));
        treatmentPatientItem.setText("Przeglądaj leczenie jako pacjent");
        treatmentPatientItem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addComponent(treatmentPatientPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(visitPatientPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
...
}//GEN-LAST:event_visitPatientItemActionPerformed

private void treatmentPatientJTreeValueChanged(javax.swing.event.TreeSelectionEvent evt) {//GEN-FIRST:event_treatmentPatientJTreeValueChanged
...
}//GEN-LAST:event_treatmentPatientJTreeValueChanged
...
private void visitDoctorSearchPatientjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_visitDoctorSearchPatientjButtonActionPerformed
    Search searchGUI = new Search(this, searchBean, getPatientDTO());
...
private void visitDoctorJTreeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_visitDoctorJTreeMouseClicked
    ...
    if (selectedNode.getUserObject() instanceof  PersonsDTO && !((DefaultTreeModel)visitDoctorJTree.getModel()).getRoot().equals(selectedNode)) {
        this.maybeShowPopup(evt, visitDoctorjPopupMenu);
    }
    ...
    private javax.swing.JPopupMenu visitDoctorjPopupMenu;
    ...
    private javax.swing.JPanel visitPatientPanel;
    ...
    public void callVisitDoctorItemActionPerformed(java.awt.event.ActionEvent evt) {
        visitDoctorItemActionPerformed(evt);
    }
}
